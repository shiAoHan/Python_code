...
def get_url():
    url = 'https://huodong.ctrip.com/things-to-do/list?pagetype=city&citytype=dt&keyword=中国&pshowcode=Ticket2'
    return url
...
def get_csv(pickpocket, city_url, t):
    ...
    while True:
        ...
        for con in cons:
            ...
            print(location)
            if location[2] != 0 or location[3] < 80:
                continue
...
def main():
    csv_path = r'C:\Users\Administrator\Desktop\全国景点地图.csv'
